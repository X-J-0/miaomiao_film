...
.cinema_body .card div.or{padding:0 3px;height:15px;line-height: 15px;border-radius: 2px;color:#f90;border:1px solid #f90;}
.cinema_body .card div.bl{padding:0 3px;height:15px;line-height: 15px;border-radius: 2px;color:#589daf;border:1px solid #589daf;}
</style>
