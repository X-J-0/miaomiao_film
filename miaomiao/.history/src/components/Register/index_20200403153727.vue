...
.register_body .register_email button{position:absolute;top:10px;right:10px;height:30px;background-color: #e54847;border-radius: 3px;border:none;padding:5px;}
</style>
