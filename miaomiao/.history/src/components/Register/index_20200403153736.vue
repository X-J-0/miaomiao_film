...
<div class="register_body">
    <div class="register_email">
        邮箱:<input class="register_text" type="text"><button>发送验证码</button>
    </div>
    <div>
      用户名：<input class="register_text" type="text">
    </div>
    <div>
      密码:<input class="register_text" type="text">
    </div>
    <div>
      验证码：<input class="register_text" type="text">
    </div>
...
.register_body .register_email button{position:absolute;top:10px;right:10px;height:30px;background-color: #e54847;border-radius: 3px;border:none;padding:5px;color:white;}
</style>
