...
.sousuo{width:47px;height:27px;line-height: 28px;text-align: center;background-color: #f03d37;color:#fff;border-radius:5px;border:transparent;margin-left:80%;}
</style>
