...
.info_list{margin-top:50px;margin-left:10px;flex:1;position: relative;}
...
.btn_mall, .movie_body .btn_pre{width:47px;height:27px;line-height: 28px;text-align: center;background-color: #f03d37;color:#fff;border-radius: 5%;}
