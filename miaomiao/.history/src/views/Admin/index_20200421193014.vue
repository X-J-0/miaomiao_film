...
.pic_show{width:64px; height:90px;margin-top: 110px;}
.pic_show img{width:100%;}
.info_list h2{font-size:17px;mar-left:-100%;line-height: 24px;width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
