...
.movie_body{position: absolute;top:150px;margin:0 12px;}
.movie_body ul li{list-style-type: none;}
.pic_show{width:64px; height:90px;margin-top: 110px;position:absolute;top:10px;left:20px;}
.pic_show img{width:100%;}
.info_list h2{position:absolute;top:10px;left:90px;line-height: 24px;width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
.info_list p{position:absolute;top:20px;left:90px;font-size:13px;color:#666;line-height: 22px;width:200px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
.info_list .grade{font-weight: 700;color:#faaf00;font-size:15px;}
.btn_pre{width:47px;height:27px;line-height: 28px;text-align: center;background-color: #f03d37;color:#fff;border-radius: 5%;}
