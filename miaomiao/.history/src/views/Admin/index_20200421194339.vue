...
.admin_body .admin_text{width:100%;height:40px;border:none;border-bottom:1px #ccc solid;margin-bottom:5px;outline:none;text-indent:10px;margin-right: 10px;}
.admin_body .admin_btn{height:50px;margin-top:15px;margin-right: 10px;}
