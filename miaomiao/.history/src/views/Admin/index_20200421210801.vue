...
.movie_bodys ul{margin:0 12px; overflow:hidden;}
...
.file-box{ position: absolute;top:150px;left:20px;width:340px;margin:20px;}
...
.file{ position:absolute; top:0; right:85px; height:30px;line-height:30px;}
</style>
