...
.movie_bodys .info_list h2{position: relative;left:40px;font-size:17px;line-height: 24px;width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin-left: -40px;}
.movie_bodys .info_list p{position: relative;left:50px;font-size:13px;color:#666;line-height: 22px;width:200px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin-left: -50px;}
