<template>
    <div class="main">
        ...
        <div v-show="3 == num">
            <div class="admin_body">
                <div>
                    <input v-model="name" class="admin_text" type="text" placeHolder="请输入要查询的电影名称" @input="changeInput">
                </div>
                <div class="admin_btn">
            ...
            <ul>
                <li>
                    <div class="pic_show" ><img :src="movieList.pic | setWH('128.180') "></div>
                    <div class="info_list">
...
<style scoped>
html,
body {height: 92%;margin: 0;padding: 0;background-color: #58596b;}
.active {color: #fff;background: #e74c3c;}
.main {width: 92%;height: 100%;background-color: #fff;box-shadow: 0 1px 3px rgba(0, 0, 0, .1);float:right; }
...
.admin_body .admin_text{width:92%;height:40px;border:none;border-bottom:1px #ccc solid;margin-bottom:5px;outline:none;text-indent:10px;margin-right: 20px;}
...
.info_list h2{position: relative;left:20px;font-size:17px;line-height: 24px;width:150px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin-left: -40px;}
.info_list p{position: relative;left:40px;font-size:13px;color:#666;line-height: 22px;width:200px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin-left: -50px;}
