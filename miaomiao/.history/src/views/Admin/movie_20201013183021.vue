...
<style scoped>
html,
body {height: 92%;margin: 0;padding: 0;background-color: #58596b;position:relative;top:-10%;}
.active {position:relative;top:-10%;color: #fff;background: #e74c3c;}
.main {position:relative;top:-10%;width: 92%;height: 100%;background-color: #fff;box-shadow: 0 1px 3px rgba(0, 0, 0, .1);float:right; }
