...
.list li{margin:0 10px;margin-right:10px;list-style-type: none;width:100%;height:60px;font-size: 18px;line-height: 60px;color:grey;border-bottom:1px solid grey;}
</style>
