<template>
    <div class="main">
      ...
      <div v-else class="info">您好，欢迎使用喵喵电影</div>
      <ul class="list">
...
.list li{margin:0 10px;list-style-type: none;width:100%;height:60px;font-size: 18px;line-height:80px;color:grey;border-bottom:1px solid brown;}
.list span{position: absolute;right:10px;color:brown;}
</style>
