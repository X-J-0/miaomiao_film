...
.list li{margin:0 10px;list-style-type: none;width:100%;height:60px;font-size: 18px;line-height:80px;color:grey;border-bottom:2px solid red;}
.list span{position: absolute;right:10px;color:red;}
</style>
